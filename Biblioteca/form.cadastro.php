...
<body>
    ...
    <div class = "container">
        <form>
            ...
            <div class="mb-3">
                <input placeholder="Digite o gênero do livro" type="text" class="form-control">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input placeholder="Digite o número de páginas do livro" type="text" class="form-control">
            </div>
